...
var axios_1 = require("axios"); // help to send HTTP request
(0, typeorm_1.createConnection)().then(function (db) {
    var productRepository = db.getMongoRepository(product_1.Product);
    amqp.connect('amqps://lddsdplh:27qOSThAbx70ZPc4s4m18HwESLGWXzjz@armadillo.rmq.cloudamqp.com/lddsdplh', function (error0, connection) {
        if (error0) {
            throw error0;
        }
